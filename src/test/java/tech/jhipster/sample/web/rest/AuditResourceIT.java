...
public class AuditResourceIT {
	...
	private static final Instant SAMPLE_TIMESTAMP = Instant.parse(
		"2015-08-04T10:11:30Z"
	);
	...
	public void getAuditsByDate() throws Exception {
		...
		String fromDate = SAMPLE_TIMESTAMP
			.minusSeconds(SECONDS_PER_DAY)
			.toString()
			.substring(0, 10);
		String toDate = SAMPLE_TIMESTAMP
			.plusSeconds(SECONDS_PER_DAY)
			.toString()
			.substring(0, 10);
	...
	public void getNonExistingAuditsByDate() throws Exception {
		...
		String fromDate = SAMPLE_TIMESTAMP
			.minusSeconds(2 * SECONDS_PER_DAY)
			.toString()
			.substring(0, 10);
		String toDate = SAMPLE_TIMESTAMP
			.minusSeconds(SECONDS_PER_DAY)
