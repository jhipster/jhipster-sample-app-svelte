...
public class AccountResourceIT {
	...
	public void testGetExistingAccount() throws Exception {
		...
		restAccountMockMvc
			...
			.andExpect(
				jsonPath("$.imageUrl").value("http://placehold.it/50x50")
			)
	...
	public void testRegisterValid() throws Exception {
		...
		validUser.setAuthorities(
			Collections.singleton(AuthoritiesConstants.USER)
		);
		assertThat(
			userRepository.findOneByLogin("test-register-valid").isPresent()
		)
			.isFalse();
	...
	public void testRegisterInvalidLogin() throws Exception {
		...
		Optional<User> user = userRepository.findOneByEmailIgnoreCase(
			"funky@example.com"
		);
	...
	public void testRegisterDuplicateLogin() throws Exception {
		...
		Optional<User> testUser = userRepository.findOneByEmailIgnoreCase(
			"alice2@example.com"
		);
	...
	public void testRegisterDuplicateEmail() throws Exception {
		...
		Optional<User> testUser1 = userRepository.findOneByLogin(
		...
		Optional<User> testUser2 = userRepository.findOneByLogin(
			"test-register-duplicate-email"
		);
		assertThat(testUser2.isPresent()).isFalse();

		Optional<User> testUser3 = userRepository.findOneByLogin(
		...
		Optional<User> testUser4 = userRepository.findOneByLogin(
	...
	public void testRegisterAdminIsIgnored() throws Exception {
		...
		Optional<User> userDup = userRepository.findOneWithAuthoritiesByLogin(
			"badguy"
		);
	...
	public void testSaveExistingEmail() throws Exception {
		...
		User updatedUser = userRepository
			.findOneByLogin("save-existing-email")
			.orElse(null);
		assertThat(updatedUser.getEmail())
			.isEqualTo("save-existing-email@example.com");
	}
	...
	public void testSaveExistingEmailAndLogin() throws Exception {
		...
		User updatedUser = userRepository
			...
			.orElse(null);
		assertThat(updatedUser.getEmail())
			.isEqualTo("save-existing-email-and-login@example.com");
	}
	...
	public void testChangePasswordWrongExistingPassword() throws Exception {
		...
		User updatedUser = userRepository
			...
			.orElse(null);
		assertThat(
			passwordEncoder.matches("new password", updatedUser.getPassword())
		)
			.isFalse();
		assertThat(
	...
	public void testChangePassword() throws Exception {
		...
		User updatedUser = userRepository
			.findOneByLogin("change-password")
			.orElse(null);
		assertThat(
			passwordEncoder.matches("new password", updatedUser.getPassword())
		)
	...
	public void testChangePasswordTooSmall() throws Exception {
		...
		String newPassword = RandomStringUtils.random(
			ManagedUserVM.PASSWORD_MIN_LENGTH - 1
		);
		...
		User updatedUser = userRepository
			.findOneByLogin("change-password-too-small")
			.orElse(null);
		assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
	}
	...
	public void testChangePasswordTooLong() throws Exception {
		...
		String newPassword = RandomStringUtils.random(
			ManagedUserVM.PASSWORD_MAX_LENGTH + 1
		);
		...
		User updatedUser = userRepository
			.findOneByLogin("change-password-too-long")
			.orElse(null);
		assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
	}
	...
	public void testChangePasswordEmpty() throws Exception {
		...
		User updatedUser = userRepository
			.findOneByLogin("change-password-empty")
			.orElse(null);
		assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
	}
	...
	public void testGetCurrentSessions() throws Exception {
		...
		restAccountMockMvc
			...
			.andExpect(status().isOk())
			.andExpect(
				jsonPath("$.[*].series").value(hasItem(token.getSeries()))
			)
			.andExpect(
				jsonPath("$.[*].ipAddress").value(hasItem(token.getIpAddress()))
			)
			.andExpect(
				jsonPath("$.[*].userAgent").value(hasItem(token.getUserAgent()))
			)
			.andExpect(
				jsonPath("$.[*].tokenDate")
					.value(hasItem(token.getTokenDate().toString()))
			);
	}
	...
	public void testInvalidateSession() throws Exception {
		...
		restAccountMockMvc
			.perform(
				delete("/api/account/sessions/invalidate-session").with(csrf())
			)
			.andExpect(status().isOk());
