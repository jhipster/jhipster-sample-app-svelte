...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, tech.jhipster.sample.domain.PersistentToken.class.getName());
            createCache(cm, tech.jhipster.sample.domain.User.class.getName() + ".persistentTokens");
