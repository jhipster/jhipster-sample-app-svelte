...
<div class="px-2 pt-2 pb-2 sm:p-0 relative sm:flex sm:mr-2">
	...
	<div
		class:hidden="{!isOpen}"
		class="sm:absolute sm:min-w-max sm:right-0 sm:mt-10 sm:w-48 py-2 sm:bg-white sm:dark:bg-gray-700 rounded sm:rounded-lg sm:shadow-lg"
	>
