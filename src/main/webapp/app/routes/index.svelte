...
<section class="m-3 bg-white shadow-md rounded p-4">
	...
	>
		...
		<div class="sm:flex-grow sm:px-4">
			...
			<div class="mt-4">
				...
				{:else}
					<div
						...
						class="px-5 py-3 bg-yellow-100 text-yellow-900 rounded"
					>
					...
					<div
						class="px-5 py-3 mt-4 bg-yellow-100 text-yellow-900
							rounded"
					>
			...
			<ul class="mt-4 pl-10 list-disc text-yellow-900 font-semibold">
				<li>
					<a
			...
			<p class="mt-4">
				...
				>
				<a
					class="font-semibold text-yellow-900"
