...
This application was generated using `JHipster Svelte` v`1.1.0` and `JHipster` v`7.9.4`, you can find documentation and help at [https://www.jhipster.tech/documentation-archive/v7.9.4](https://www.jhipster.tech/documentation-archive/v7.9.4).
