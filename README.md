...
This application was generated using `Svelte Hipster` v`0.5.0` and `JHipster` v`7.1.0`, you can find documentation and help at [https://www.jhipster.tech/documentation-archive/v7.1.0](https://www.jhipster.tech/documentation-archive/v7.1.0).
